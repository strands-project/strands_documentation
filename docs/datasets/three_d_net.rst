...
|  Walter Wohlkinger, Aitor Aldoma Buchaca, Radu Rusu, Markus Vincze. *"3DNet: Large-Scale Object Class Recognition from CAD Models"*. In IEEE International Conference on Robotics and Automation (ICRA), 2012. (`PDF <wohlkinger20123dnet.pdf>`__) (`bibtex <wohlkinger20123dnet.bib>`__)
...
-  Cat10: Basic object classes
   ...
   `Cat10\_ModelDatabase.zip (42 MB) <Cat10_ModelDatabase.zip>`__

   `Cat10\_TestDatabase.zip (3.6 GB) <Cat10_TestDatabase.zip>`__
...
-  Cat60: Subclasses
   ...
   `Cat60\_ModelDatabase.zip (222 MB) <Cat60_ModelDatabase.zip>`__

   `Cat60\_TestDatabase.zip (3.7 GB) <Cat60_TestDatabase.zip>`__
